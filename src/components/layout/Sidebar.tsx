  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-3 right-4 z-40 p-2.5 bg-white dark:bg-slate-900/80 backdrop-blur-md border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 rounded-xl shadow-sm hover:bg-slate-50 dark:bg-slate-950/50 focus:outline-none focus:ring-2 focus:ring-primary-100 transition-all"
        title="Buka Menu"
      >
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 w-70 bg-white dark:bg-slate-900 border-r border-slate-100 dark:border-slate-800/50 flex flex-col z-50 transform transition-transform duration-300 ease-in-out lg:translate-x-0",
      ...
      >
        <div className="p-6 border-b border-slate-100 dark:border-slate-800/50 flex items-center justify-between">
          ...
          <button
            onClick={() => setIsMobileMenuOpen(false)}
            className="lg:hidden p-2 text-slate-400 hover:text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-800 rounded-lg transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-4 border-t border-slate-100 dark:border-slate-800/50 space-y-3 bg-slate-50/50">
          <button
            onClick={() => {
              setIsMobileMenuOpen(false);
              setShowLogoutModal(true);
            }}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-slate-600 dark:text-slate-400 hover:text-red-600 hover:bg-red-50 transition-all font-medium"
          >
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[60] flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl max-w-sm w-full p-6 zoom-in-95 animate-in duration-200">
            ...
            <div className="bg-slate-50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800/50 rounded-xl p-3.5 mb-6">
            ...
            <div className="flex gap-3 justify-end">
              <button
                ...
                className="px-4 py-2.5 rounded-xl text-sm font-medium text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:bg-slate-950/50 transition-colors disabled:opacity-50"
              >
                Batal
              </button>
              <button
